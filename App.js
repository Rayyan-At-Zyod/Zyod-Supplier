...
import { foregroundService } from "./services/offline/foreground.service";
  ...
  useEffect(() => {
    const initializeApp = async () => {
      try {
        ...
        // Start foreground service for processing pending actions
    ...
    // Cleanup function to stop the service when app is closed
    return () => {
